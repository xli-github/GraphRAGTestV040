# 1、GraphRAG介绍
就在两天前(2024.11.5)GraphRAG 已经发布 0.4.0新版本，该版本的代码经过一轮重构后，已于之前的代码结构有了很大的不同        
该版本引入增量更新索引和DRIFT图推理搜索查询，这是一种混合本地与全局的搜索的方法        
...
微软的研究合作伙伴 Uncharted Software正在进一步拓展此技术，开发出一种全新方法：DRIFT 搜索（动态推理与灵活遍历）
DRIFT 在微软的 GraphRAG 技术之上进行改进，将全局搜索和本地搜索结合起来，以平衡计算成本与响应质量           
